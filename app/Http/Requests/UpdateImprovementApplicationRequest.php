...
class UpdateImprovementApplicationRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $rules['unit_id'] = 'required|unique:improvement_applications,unit_id,'. $this->improvement_application->id;
        ...
        if($this->improvement_type === 'EXTERIOR') {
            if(!in_array("Balcony", $this->additional_structure) || 
                !in_array("Second Floor Room Extension", $this->additional_structure)) {
